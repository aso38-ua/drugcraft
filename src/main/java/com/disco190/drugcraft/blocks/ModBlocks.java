...
public class ModBlocks {
        ...
        public static final RegistryObject<Block> DEHYDRATOR = BLOCKS.register("dehydrator",
                        () -> new DehydratorBlock(
                                        BlockBehaviour.Properties
                                                        .of()
                                                        .strength(3.5F)
        ...
        public static final RegistryObject<Block> TRAY =
                        // CORRECCIÓN: Usar una expresión lambda para pasar las propiedades requeridas
                        // por el constructor
        ...
        public static final RegistryObject<Block> MIMOSA_SAPLING = BLOCKS.register("mimosa_sapling",
                        () -> new SaplingBlock(new MimosaTreeGrower(),
