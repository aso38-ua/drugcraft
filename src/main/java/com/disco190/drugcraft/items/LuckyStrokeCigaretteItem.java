...
public class LuckyStrokeCigaretteItem extends CigaretteItem{
    public LuckyStrokeCigaretteItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level world, LivingEntity entityLiving) {
        ...
        if (!world.isClientSide && entityLiving instanceof Player player) {
            player.addEffect(new MobEffectInstance(MobEffects.LUCK, 900, 0));
