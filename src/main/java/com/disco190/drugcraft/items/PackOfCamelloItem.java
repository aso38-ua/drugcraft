...
public class PackOfCamelloItem extends PackOfCigaretteItem{

    public PackOfCamelloItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (!world.isClientSide) {
            ...
            ItemStack cigarette = new ItemStack(ModItems.CAMELLO_CIGARETTE.get());
