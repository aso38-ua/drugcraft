                        ...
                        () -> new CoughSyrupItem(new Item.Properties()
                                        ...
                                        .food(new FoodProperties.Builder()
                                                        ...
                                                        .effect(() -> new MobEffectInstance(
                                                                        MobEffects.DAMAGE_RESISTANCE, 20 * 10, 0), 1.0F)
        ...
        public static final RegistryObject<Item> PEYOTE = ITEMS.register("peyote",
                        () -> new Item(new Item.Properties()
                                        .food(new FoodProperties.Builder()
                                                        ...
                                                        .effect(() -> new MobEffectInstance(
                                                                        ModEffects.HALLUCINATION.get(), 20 * 20, 0),
                                                                        1.0f)
                                                        .effect(() -> new MobEffectInstance(MobEffects.CONFUSION,
                                                                        20 * 30, 0), 1.0f) // nausea 30s
                                                        .effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION,
                                                                        20 * 40, 0), 1.0f) // night vision 1m
                                                        .effect(() -> new MobEffectInstance(MobEffects.GLOWING, 20 * 30,
                                                                        0), 1.0f)
                                                        .build())));
